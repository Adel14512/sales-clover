...
$("#btnSubmitStep2").click(function () {
    ...
    $.ajax({
        type: 'POST',
        url: '/Slip/SalesTransactionBL331211UpdSlip2',
        data: formData,
        processData: false,
        contentType: false,
...
$("#btnSubmitStep3").click(function () {
    ...
    $.ajax({
        type: 'POST',
        url: '/Slip/SalesTransactionBL331211UpdSlip3',
        data: formData,
        processData: false,
        contentType: false,
...
$("#btnSubmitStep4").click(function () {
    ...
    $.ajax({
        type: 'POST',
        url: '/Slip/SalesTransactionBL331211UpdSlip4',
        data: formData,
        processData: false,
        contentType: false,
...
$("#btnSubmitStep5").click(function () {
    ...
    var obj = {};
    obj.RecId = trxID;
    obj.Slip5BL331211 = listLinkedList;
    formData.append('slip', JSON.stringify(obj));
    $.ajax({
        type: 'POST',
        url: '/Slip/SalesTransactionBL331211UpdSlip5',
        data: formData,
        processData: false,
        contentType: false,
