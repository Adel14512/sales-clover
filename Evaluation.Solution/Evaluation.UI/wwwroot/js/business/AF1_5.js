...
$('#fileInput').change(function () {
    ...
    if (fileName != '') {
        ...
        formData.append('code', "AF1_5");

        $.ajax({
            type: 'POST',
            url: '/ExcelImport/ImportExcelAF1_5',
            data: formData,
            processData: false,
            contentType: false,
...
$("#btnSendEmailExcel").click(function () {
    ...
    formData.append('businessPage', JSON.stringify("AF1_5"));
...
function submitAF(isSent) {
    ...
    obj.RecId = trxID;
    obj.AF1BL051807 = dataList;
    formBody.append("data", JSON.stringify(obj));
    if (trxID != 0) {

        $.ajax({
            url: "/Business/EditAF1_5",
            type: "POST",
            contentType: false,
            processData: false,
            data: formBody,
            ...
            success: function (data) {
                ...
                if (data != null && data.webResponseCommon.returnCode == '202') {
                    ...
                    if (isSent) {
                        downloadEmptyExcel(BusinessLineCode, JSON.stringify("AF1_5"), JSON.stringify("AF"));
                    } else {
