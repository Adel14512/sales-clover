...
function Submit() {
    ...
    var af8Obj = {};
    af8Obj.ResidenceCode = $("#AF1BL080501Dtco_ResidenceCode").val();
    af8Obj.NetworkLevelCode = $("#AF1BL080501Dtco_NetworkLevelCode").val();
    af8Obj.ClassOfCoveragCode = parseInt($("#AF1BL080501Dtco_ClassOfCoveragCode").val());
    af8Obj.Ambulatory = $("#AF1BL080501Dtco_Ambulatory").val().toLowerCase() == 'true' ? true : false;
    af8Obj.PrescriptionMedecine = $("#AF1BL080501Dtco_PrescriptionMedecine").val().toLowerCase() == 'true' ? true : false;
    af8Obj.DoctorVisit = $("#AF1BL080501Dtco_DoctorVisit").val().toLowerCase() == 'true' ? true : false;
    af8Obj.NSSF = $("#AF1BL080501Dtco_NSSF").val().toLowerCase() == 'true' ? true : false;

    if (af8Obj.Ambulatory == true && af8Obj.PrescriptionMedecine == true && af8Obj.DoctorVisit == true) {

    } else if (af8Obj.Ambulatory == true && af8Obj.PrescriptionMedecine == true && af8Obj.DoctorVisit == false) {
    } else if (af8Obj.Ambulatory == true && af8Obj.PrescriptionMedecine == false && af8Obj.DoctorVisit == false) {
    } else if (af8Obj.Ambulatory == false && af8Obj.PrescriptionMedecine == false && af8Obj.DoctorVisit == false) {
    } else {
    ...
    if ($("#form").valid()) {
        ...
        af8Obj.AF1BL080501List = getValues();
        obj.AF1BL080501 = af8Obj;
        obj.RecId = trxID;
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    try {
                        ...
                        if (data.message.includes("System.DateTime")) {
                            toastr.warning("Please fix required fields", "UnSaved");
                        }
...
function addRow() {
    if (totalrow < 8) {
        ...
        cells[4].innerHTML = '<select class="form-select required" required id="Gender" >' + selectGenderlHtml + '</select>';
...
//// Initial population of Master dropdown based on the initial selected Client
//var initialSelectedClientId = parseInt(clientID);
//populateMasterDropdown(initialSelectedClientId);