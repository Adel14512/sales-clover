...
function Submit() {
    ...
    if ($("#form").valid()) {
        ...
        var af8Obj = {};
        af8Obj.FirstName = $("#AF1BL061005Dto_FirstName").val();
        af8Obj.MiddleName = $("#AF1BL061005Dto_MiddleName").val()
        af8Obj.LastName = $("#AF1BL061005Dto_LastName").val()
        af8Obj.GenderCode = $("#AF1BL061005Dto_GenderCode").val()
        af8Obj.DOB = $("#AF1BL061005Dto_DOB").val()
        af8Obj.NationalityCode = $("#AF1BL061005Dto_NationalityCode").val()
        af8Obj.MaritalStatusCode = $("#AF1BL061005Dto_MaritalStatusCode").val()
        af8Obj.CountryOfResidenceCode = $("#AF1BL061005Dto_CountryOfResidenceCode").val()
        af8Obj.RequestedLimitCurrency = $("#AF1BL061005Dto_RequestedLimitCurrency").val()
        af8Obj.Occupation = $("#AF1BL061005Dto_Occupation").val()
        af8Obj.ReasonOfInsurance = $("#AF1BL061005Dto_ReasonOfInsurance").val()
       // af8Obj.AF1BL061005List = getValues();
        listSave.push(af8Obj)
        obj.AF1BL061005 = listSave;
        obj.RecId = trxID;
        obj.BusinessLineCode = BusinessLineCode;
        formBody.append("data", JSON.stringify(obj));
        if (trxID != 0) {
            $.ajax({
                url: "/Business/EditAF1_6",
                type: "POST",
                contentType: false,
                processData: false,
                data: formBody,
