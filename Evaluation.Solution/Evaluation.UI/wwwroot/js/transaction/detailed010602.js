$('#tableDashboardShort').DataTable({
    ...
    columns: [
        ...
        { data: 'insurred', title:'Insured' },
        { data: 'aF1Age', title: 'Age' },
        { data: 'insurerProduct', title: 'Insurer Product' },
        { data: 'sheet', title: 'Sheet' },
        { data: 'combination', title: 'Comnination' },
        { data: 'membersCount', title: 'Member' },
        ...
        {
            data: 'costPolicy', title: 'Policy Cost',
            render: function (data, type, row) {
                if (type === 'display') {
...
$("#btnQuotation").click(function () {
    ...
    excelOrPdfExport($("#PageType").val(), $("#ContactId").val(), $("#BusinessLineCode").val(), params, false, 'CQ', $("#SalestransactionID").val());
});
$("#btnOfficialQuote").click(function () {
    var params = encodeParameters("?contactId=" + $("#ContactId").val() + "&trxid=" + $("#SalestransactionID").val() + "&businesslinecode=" + $("#BusinessLineCode").val());
    excelOrPdfExport($("#PageType").val(), $("#ContactId").val(), $("#BusinessLineCode").val(), params, true, 'CQOFF', $("#SalestransactionID").val());
});
function excelOrPdfExport(pageaction, contactID, businessCode, params, ispdf, type, trxID) {
