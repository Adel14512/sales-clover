...
$(document).ready(function () {
    ...
    var tInsured = $('#tInsured').DataTable({
        data: salesTransactionBL010602.aF1BL010602.sort(customSort),
        responsive: true,
        autoWidth: true,
        ordering: false,
        columns: [
    ...
    function createUpdateConsolidation(model) {
        ...
        if (modelfile == null) {
            ...
            $.ajax({
                type: 'POST',
                url: '/Consolidation/CreateConsolidationDocument010602',
                data: formData,
                processData: false,
                contentType: false,
            ...
            $.ajax({
                type: 'POST',
                url: '/Consolidation/UpdateConsolidationDocument010602',
                data: formData,
                processData: false,
                contentType: false,
                beforeSend: function (xhr) {
    ...
    function SubmitAf8(isClientMaster) {
        if (isClientMaster) {
            ...
            if ($("#form").valid()) {
                ...
                var formBody = new FormData();
                var af8Obj = {};
                af8Obj.ResidenceCode = salesTransactionBL010602.aF1BL010602.residenceCode;
                af8Obj.NetworkLevelCode = salesTransactionBL010602.aF1BL010602.networkLevelCode;
                af8Obj.ClassOfCoveragCode = salesTransactionBL010602.aF1BL010602.classOfCoveragCode;
                af8Obj.Ambulatory = salesTransactionBL010602.aF1BL010602.ambulatory;
                af8Obj.PrescriptionMedecine = salesTransactionBL010602.aF1BL010602.prescriptionMedecine;
                af8Obj.DoctorVisit = salesTransactionBL010602.aF1BL010602.doctorVisit;
                af8Obj.NSSF = salesTransactionBL010602.aF1BL010602.nssf;
                af8Obj.AF1BL010602List = getValues();
                obj.AF1BL010602 = af8Obj;
...
function Submit() {
    ...
    formBody.append("data", JSON.stringify(obj));
    $.ajax({
        url: "/Consolidation/UpdateConsolidationForm010602",
        type: "POST",
        contentType: false,
        processData: false,
        data: formBody,
