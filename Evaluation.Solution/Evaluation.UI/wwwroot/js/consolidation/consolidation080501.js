...
$(document).ready(function () {
    ...
    var tInsured = $('#tInsured').DataTable({
        data: salesTransactionBL080501.aF1BL080501.aF1BL080501List.sort(customSort),
        responsive: true,
        autoWidth: true,
        ordering: false,
        columns: [
    ...
    function createUpdateConsolidation(model) {
        ...
        if (modelfile == null) {
            ...
            $.ajax({
                type: 'POST',
                url: '/Consolidation/CreateConsolidationDocument080501',
                data: formData,
                processData: false,
                contentType: false,
    ...
    function SubmitAf8(isClientMaster) {
        if (isClientMaster) {
            ...
            if ($("#form").valid()) {
                ...
                var formBody = new FormData();
                var af8Obj = {};
                af8Obj.ResidenceCode = salesTransactionBL080501.aF1BL080501.residenceCode;
                af8Obj.NetworkLevelCode = salesTransactionBL080501.aF1BL080501.networkLevelCode;
                af8Obj.ClassOfCoveragCode = salesTransactionBL080501.aF1BL080501.classOfCoveragCode;
                af8Obj.Ambulatory = salesTransactionBL080501.aF1BL080501.ambulatory;
                af8Obj.PrescriptionMedecine = salesTransactionBL080501.aF1BL080501.prescriptionMedecine;
                af8Obj.DoctorVisit = salesTransactionBL080501.aF1BL080501.doctorVisit;
                af8Obj.NSSF = salesTransactionBL080501.aF1BL080501.nssf;
...
function Submit() {
   // if ($("#formstep5").valid()) {
        ...
        formBody.append("data", JSON.stringify(obj));
        $.ajax({
            url: "/Consolidation/UpdateConsolidationForm080501",
            type: "POST",
            contentType: false,
            processData: false,
            data: formBody,
