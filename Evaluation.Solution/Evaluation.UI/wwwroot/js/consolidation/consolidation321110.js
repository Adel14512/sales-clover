...
$(document).ready(function () {
    ...
    $('#tPolicies tbody').on('click', 'tr', function () {
        ...
        //draw data
        $("#MasterId").val(salesTransactionBL321110.masterId).change();
        $("#ClientId").val(salesTransactionBL321110.clientId).change();
        $("#MasterClientRecID").val(salesTransactionBL321110.recId);
    ...
    var tInsured = $('#tInsured').DataTable({
        data: salesTransactionBL321110.aF1BL321110.sort(customSort),
        responsive: true, 
        autoWidth: true,
        ordering: false,
        columns: [
    ...
    function createUpdateConsolidation(model) {
        ...
        if (modelfile == null) {
            ...
            $.ajax({
                type: 'POST',
                url: '/Consolidation/CreateConsolidationDocument321110',
                data: formData,
                processData: false,
                contentType: false,
            ...
            $.ajax({
                type: 'POST',
                url: '/Consolidation/UpdateConsolidationDocument321110',
                data: formData,
                processData: false,
                contentType: false,
                beforeSend: function (xhr) {
    ...
    function SubmitAf32(isClientMaster) {
        if (isClientMaster) {
            ...
            $.ajax({
                url: "/Business/EditAF1_32Consolidation",
                type: "POST",
                contentType: false,
                processData: false,
                data: formBody,
            ...
            if ($("#form").valid()) {
                ...
                var formBody = new FormData();
                var af8Obj = {};
                af8Obj.ResidenceCode = salesTransactionBL321110.aF1BL321110.residenceCode;
                af8Obj.NetworkLevelCode = salesTransactionBL321110.aF1BL321110.networkLevelCode;
                af8Obj.ClassOfCoveragCode = salesTransactionBL321110.aF1BL321110.classOfCoveragCode;
                af8Obj.Ambulatory = salesTransactionBL321110.aF1BL321110.ambulatory;
                af8Obj.PrescriptionMedecine = salesTransactionBL321110.aF1BL321110.prescriptionMedecine;
                af8Obj.DoctorVisit = salesTransactionBL321110.aF1BL321110.doctorVisit;
                af8Obj.NSSF = salesTransactionBL321110.aF1BL321110.nssf;
                af8Obj.AF1BL321110List = getValues();
                obj.AF1BL321110 = af8Obj;
...
function Submit() {
    ...
    formBody.append("data", JSON.stringify(obj));
    $.ajax({
        url: "/Consolidation/UpdateConsolidationForm321110",
        type: "POST",
        contentType: false,
        processData: false,
        data: formBody,
