...
$(document).ready(function () {
    ...
    $('#tPolicies tbody').on('click', 'tr', function () {
        ...
        //draw data
        $("#MasterId").val(salesTransactionBL281609.masterId).change();
        $("#ClientId").val(salesTransactionBL281609.clientId).change();
        $("#MasterClientRecID").val(salesTransactionBL281609.recId);
    ...
    var tInsured = $('#tInsured').DataTable({
        data: salesTransactionBL281609.aF1BL281609,
        responsive: true,
        autoWidth: true,
        ordering: false,
        columns: [
    ...
    function createUpdateConsolidation(model) {
        ...
        if (modelfile == null) {
            ...
            $.ajax({
                type: 'POST',
                url: '/Consolidation/CreateConsolidationDocument281609',
                data: formData,
                processData: false,
                contentType: false,
            ...
            $.ajax({
                type: 'POST',
                url: '/Consolidation/UpdateConsolidationDocument281609',
                data: formData,
                processData: false,
                contentType: false,
                beforeSend: function (xhr) {
    ...
    function SubmitAf8(isClientMaster) {
        if (isClientMaster) {
            ...
            $.ajax({
                url: "/Business/EditAF1_28Consolidation",
                type: "POST",
                contentType: false,
                processData: false,
                data: formBody,
            ...
            if ($("#form").valid()) {
                ...
                var formBody = new FormData();
                var af8Obj = {};
                af8Obj.ResidenceCode = salesTransactionBL281609.aF1BL281609.residenceCode;
                af8Obj.NetworkLevelCode = salesTransactionBL281609.aF1BL281609.networkLevelCode;
                af8Obj.ClassOfCoveragCode = salesTransactionBL281609.aF1BL281609.classOfCoveragCode;
                af8Obj.Ambulatory = salesTransactionBL281609.aF1BL281609.ambulatory;
                af8Obj.PrescriptionMedecine = salesTransactionBL281609.aF1BL281609.prescriptionMedecine;
                af8Obj.DoctorVisit = salesTransactionBL281609.aF1BL281609.doctorVisit;
                af8Obj.NSSF = salesTransactionBL281609.aF1BL281609.nssf;
                af8Obj.AF1BL281609List = getValues();
                obj.AF1BL281609 = af8Obj;
...
function Submit() {
    ...
    formBody.append("data", JSON.stringify(obj));
    $.ajax({
        url: "/Consolidation/UpdateConsolidationForm281609",
        type: "POST",
        contentType: false,
        processData: false,
        data: formBody,
