...
$(document).ready(function () {
    ...
    $('#tPolicies tbody').on('click', 'tr', function () {
        ...
        //draw data
        $("#MasterId").val(salesTransactionBL070806.masterId).change();
        $("#ClientId").val(salesTransactionBL070806.clientId).change();
        $("#MasterClientRecID").val(salesTransactionBL070806.recId);
    ...
    var tInsured = $('#tInsured').DataTable({
        data: salesTransactionBL070806.aF1BL070806.aF1BL070806List.sort(customSort),
        responsive: true,
        autoWidth: true,
        ordering: false,
        columns: [
    ...
    function createUpdateConsolidation(model) {
        ...
        if (modelfile == null) {
            ...
            $.ajax({
                type: 'POST',
                url: '/Consolidation/CreateConsolidationDocument070806',
                data: formData,
                processData: false,
                contentType: false,
    ...
    function SubmitAf8(isClientMaster) {
        if (isClientMaster) {
            ...
            if ($("#form").valid()) {
                ...
                var formBody = new FormData();
                var af8Obj = {};
                af8Obj.ResidenceCode = salesTransactionBL070806.aF1BL070806.residenceCode;
                af8Obj.NetworkLevelCode = salesTransactionBL070806.aF1BL070806.networkLevelCode;
                af8Obj.ClassOfCoveragCode = salesTransactionBL070806.aF1BL070806.classOfCoveragCode;
                af8Obj.Ambulatory = salesTransactionBL070806.aF1BL070806.ambulatory;
                af8Obj.PrescriptionMedecine = salesTransactionBL070806.aF1BL070806.prescriptionMedecine;
                af8Obj.DoctorVisit = salesTransactionBL070806.aF1BL070806.doctorVisit;
                af8Obj.NSSF = salesTransactionBL070806.aF1BL070806.nssf;
...
function Submit() {
    ...
    formBody.append("data", JSON.stringify(obj));
    $.ajax({
        url: "/Consolidation/UpdateConsolidationForm070806",
        type: "POST",
        contentType: false,
        processData: false,
        data: formBody,
