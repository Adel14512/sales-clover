...
$(document).ready(function () {
    ...
    function createUpdateConsolidation(model) {
        ...
        if (modelfile == null) {
            ...
            $.ajax({
                type: 'POST',
                url: '/Consolidation/CreateConsolidationDocument331211',
                data: formData,
                processData: false,
                contentType: false,
            ...
            $.ajax({
                type: 'POST',
                url: '/Consolidation/UpdateConsolidationDocument331211',
                data: formData,
                processData: false,
                contentType: false,
                beforeSend: function (xhr) {
    ...
    function SubmitAf32(isClientMaster) {
        if (isClientMaster) {
            ...
            $.ajax({
                url: "/Business/EditAF1_33Consolidation",
                type: "POST",
                contentType: false,
                processData: false,
                data: formBody,
            ...
            if ($("#form").valid()) {
                ...
                var formBody = new FormData();
                var af8Obj = {};
                af8Obj.ResidenceCode = salesTransactionBL331211.aF1BL331211.residenceCode;
                af8Obj.NetworkLevelCode = salesTransactionBL331211.aF1BL331211.networkLevelCode;
                af8Obj.ClassOfCoveragCode = salesTransactionBL331211.aF1BL331211.classOfCoveragCode;
                af8Obj.Ambulatory = salesTransactionBL331211.aF1BL331211.ambulatory;
                af8Obj.PrescriptionMedecine = salesTransactionBL331211.aF1BL331211.prescriptionMedecine;
                af8Obj.DoctorVisit = salesTransactionBL331211.aF1BL331211.doctorVisit;
                af8Obj.NSSF = salesTransactionBL331211.aF1BL331211.nssf;
                af8Obj.AF1BL331211List = getValues();
                obj.AF1BL331211 = af8Obj;
...
function Submit() {
    ...
    formBody.append("data", JSON.stringify(obj));
    $.ajax({
        url: "/Consolidation/UpdateConsolidationForm331211",
        type: "POST",
        contentType: false,
        processData: false,
        data: formBody,
