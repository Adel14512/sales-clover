...
$(document).ready(function () {
    ...
    $('#tPolicies tbody').on('click', 'tr', function () {
        ...
        //draw data
        $("#MasterId").val(salesTransactionBL090703.masterId).change();
        $("#ClientId").val(salesTransactionBL090703.clientId).change();
        $("#MasterClientRecID").val(salesTransactionBL090703.recId);
    ...
    var tInsured = $('#tInsured').DataTable({
        data: salesTransactionBL090703.aF1BL090703.sort(customSort),
        responsive: true,
        autoWidth: true,
        ordering: false,
        columns: [
    ...
    function createUpdateConsolidation(model) {
        ...
        if (modelfile == null) {
            ...
            $.ajax({
                type: 'POST',
                url: '/Consolidation/CreateConsolidationDocument090703',
                data: formData,
                processData: false,
                contentType: false,
            ...
            $.ajax({
                type: 'POST',
                url: '/Consolidation/UpdateConsolidationDocument090703',
                data: formData,
                processData: false,
                contentType: false,
                beforeSend: function (xhr) {
    ...
    function SubmitAf8(isClientMaster) {
        if (isClientMaster) {
            ...
            if ($("#form").valid()) {
                ...
                var formBody = new FormData();
                var af8Obj = {};
                af8Obj.ResidenceCode = salesTransactionBL090703.aF1BL090703.residenceCode;
                af8Obj.NetworkLevelCode = salesTransactionBL090703.aF1BL090703.networkLevelCode;
                af8Obj.ClassOfCoveragCode = salesTransactionBL090703.aF1BL090703.classOfCoveragCode;
                af8Obj.Ambulatory = salesTransactionBL090703.aF1BL090703.ambulatory;
                af8Obj.PrescriptionMedecine = salesTransactionBL090703.aF1BL090703.prescriptionMedecine;
                af8Obj.DoctorVisit = salesTransactionBL090703.aF1BL090703.doctorVisit;
                af8Obj.NSSF = salesTransactionBL090703.aF1BL090703.nssf;
...
function Submit() {
    ...
    formBody.append("data", JSON.stringify(obj));
    $.ajax({
        url: "/Consolidation/UpdateConsolidationForm090703",
        type: "POST",
        contentType: false,
        processData: false,
        data: formBody,
