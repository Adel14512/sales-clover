...
namespace Evaluation.DAL.IDao
{
    public interface IUserCredDao
    {
        ...
        SalesTransactionBL77Dto SalesTransactionBL77NewRec(int businessLineId, int contactId, List<AF1BL77Dto> aF1BL77Dto, string createdBy);
        ...
        List<PolicyBL321110Dto> PolicyBL321110NewRec(int salesTransactionId, string InsurerCode, string ThirdPartyAdminCode, string businessLineCode, string createdBy);
        ...
        PolicyRelatedDocBL321110Dto PolicyRelatedDocBL321110UpdRec(int recId, byte[] attachDocBinary,
            string attachDocName, string attachedDocExt, string lastModifiedBy);
        PolicyRelatedDocBL321110Dto PolicyRelatedDocBL321110NewRec(int salesTransactionId, int ticketId,
            string parentPolicyId, string policyId, string businessLineCode, string documentType,
